defmodule AntlUtilsElixir.URI.QueryTest do
  use ExUnit.Case, async: true

  import AntlUtilsElixir.URI.Query, only: [decode: 1, encode: 1, encode: 2]
  doctest AntlUtilsElixir.URI.Query
  ...
  defp decode_pair(pairs) do
    Enum.reduce(Enum.reverse(pairs), %{}, &AntlUtilsElixir.URI.Query.decode_pair(&1, &2))
  end
