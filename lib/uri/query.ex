# copied from https://raw.githubusercontent.com/elixir-plug/plug/master/lib/plug/conn/query.ex

defmodule AntlUtilsElixir.URI.Query do
  @moduledoc """
  Conveniences for decoding and encoding url encoded queries.

  URI.Query allows a developer to build query strings
  ...
  defp decode_www_form(value) do
    try do
      ...
      ArgumentError ->
        raise ArgumentError, "invalid www-form encoding on query-string, got #{value}"
    end
  end
